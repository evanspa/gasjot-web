    ...
    render() {
        ...
        if (_.isEmpty(authToken)) {
            nav = (<Nav pullRight>
                ...
                <LinkContainer to={{ pathname: urls.SIGNUP_URI }}><NavItem eventKey={2} role="presentation">Sign up</NavItem></LinkContainer>
                <LinkContainer to={{ pathname: urls.LOGIN_URI }}><NavItem eventKey={3}role="presentation">Log in</NavItem></LinkContainer>
                <LinkContainer to={{ pathname: urls.SUPPORT_URI }}><NavItem eventKey={4}role="presentation">Support</NavItem></LinkContainer>
            </Nav>)
        } else {
            nav = (<Nav pullRight>
                <LinkContainer to={{ pathname: urls.ROOT_URI }} onlyActiveOnIndex><NavItem eventKey={1} role="presentation">Home</NavItem></LinkContainer>
                ...
                <LinkContainer to={{ pathname: urls.SUPPORT_URI }}><NavItem eventKey={5}role="presentation">Support</NavItem></LinkContainer>
            </Nav>)
        }
        return (
